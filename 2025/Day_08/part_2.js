...
/* eslint-disable no-sequences, indent */
...
const res = ((
    ...
    ))), [...Object.values(dist)[circs.flatMap(
        (x)=> x.size === 1 ? [Object.values(dist).findIndex((y) => y.has([...x][0]))] : [],
    ).sort((a, b) => b - a)[0]]].map((y) => INPUT[y][1][0]).reduce((a, c) => a * c, 1)
))();

const pEnd = performance.now();

console.log("PRODUCT OF X COORDS: " + res);

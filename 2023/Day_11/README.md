Link: <https://adventofcode.com/2023/day/11> <br>
...
Now, instead of the expansion you did before, make each empty row or column ** times** larger. That is, each empty row should be replaced with `1000000` empty rows, and each empty column should be replaced with `1000000` empty columns.
